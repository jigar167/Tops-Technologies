...
var useSyncExternalStore = realHook || function(subscribe, getSnapshot, getServerSnapshot) {
    ...
    value !== getSnapshot()) {
        ...
        globalThis.__DEV__ !== false && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$apollo$2f$client$2f$utilities$2f$globals$2f$invariantWrappers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["invariant"].error(92);
    }
...
function parser(document) {
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$apollo$2f$client$2f$utilities$2f$deprecation$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["warnDeprecated"])("parser", function() {
        globalThis.__DEV__ !== false && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$apollo$2f$client$2f$utilities$2f$globals$2f$invariantWrappers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["invariant"].warn(94);
    });
    if (!cache) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$apollo$2f$client$2f$utilities$2f$globals$2f$invariantWrappers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["invariant"])(!!document && !!document.kind, 95, document);
    var fragments = [];
    var queries = [];
    var mutations = [];
    var subscriptions = [];
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$apollo$2f$client$2f$utilities$2f$globals$2f$invariantWrappers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["invariant"])(!fragments.length || queries.length || mutations.length || subscriptions.length, 96);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$apollo$2f$client$2f$utilities$2f$globals$2f$invariantWrappers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["invariant"])(definitions.length === 1, 98, document, definitions.length);
...
function verifyDocumentType(document, type) {
    var operation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$apollo$2f$client$2f$utilities$2f$deprecation$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["muteDeprecations"])("parser", parser, [
        document
    ]);
    var requiredOperationName = operationName(type);
    var usedOperationName = operationName(operation.type);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$apollo$2f$client$2f$utilities$2f$globals$2f$invariantWrappers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["invariant"])(operation.type === type, 99, requiredOperationName, requiredOperationName, usedOperationName);
} //# sourceMappingURL=index.js.map
}),
...
function useApolloClient(override) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$apollo$2f$client$2f$utilities$2f$globals$2f$invariantWrappers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["invariant"])(!!client, 79);
    return client;
} //# sourceMappingURL=useApolloClient.js.map
}),
"[project]/node_modules/@apollo/client/react/hooks/internal/useWarnRemovedOption.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useWarnRemovedOption(options, name, callSite, recommendation) {
    ...
    var didWarn = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rehackt$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"](false);
    if (name in options && !didWarn.current) {
        globalThis.__DEV__ !== false && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$apollo$2f$client$2f$utilities$2f$globals$2f$invariantWrappers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["invariant"].warn(78, callSite, name, recommendation);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$apollo$2f$client$2f$react$2f$hooks$2f$internal$2f$useWarnRemovedOption$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@apollo/client/react/hooks/internal/useWarnRemovedOption.js [app-client] (ecmascript)");
...
function useQuery(query, options) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$apollo$2f$client$2f$react$2f$hooks$2f$internal$2f$wrapHook$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["wrapHook"])("useQuery", useQuery_, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$apollo$2f$client$2f$react$2f$hooks$2f$useApolloClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useApolloClient"])(options && options.client))(query, options);
}
function useQuery_(query, options) {
    if (globalThis.__DEV__ !== false) {
        /* eslint-disable react-hooks/rules-of-hooks, react-compiler/react-compiler */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$apollo$2f$client$2f$react$2f$hooks$2f$internal$2f$useWarnRemovedOption$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useWarnRemovedOption"])(options, "canonizeResults", "useQuery");
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$apollo$2f$client$2f$react$2f$hooks$2f$internal$2f$useWarnRemovedOption$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useWarnRemovedOption"])(options, "partialRefetch", "useQuery");
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$apollo$2f$client$2f$react$2f$hooks$2f$internal$2f$useWarnRemovedOption$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useWarnRemovedOption"])(options, "defaultOptions", "useQuery", "Pass the options directly to the hook instead.");
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$apollo$2f$client$2f$react$2f$hooks$2f$internal$2f$useWarnRemovedOption$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useWarnRemovedOption"])(options, "onCompleted", "useQuery", "If your `onCompleted` callback sets local state, switch to use derived state using `data` returned from the hook instead. Use `useEffect` to perform side-effects as a result of updates to `data`.");
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$apollo$2f$client$2f$react$2f$hooks$2f$internal$2f$useWarnRemovedOption$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useWarnRemovedOption"])(options, "onError", "useQuery", "If your `onError` callback sets local state, switch to use derived state using `data`, `error` or `errors` returned from the hook instead. Use `useEffect` if you need to perform side-effects as a result of updates to `data`, `error` or `errors`.");
...
//# sourceMappingURL=node_modules_cbeeef10._.js.map